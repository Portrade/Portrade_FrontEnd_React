...
const Home = () => {
    ...
    const homeButtonList = buttons.map((button) => {
        switch (button.id) {
            ...
            case 2:
                return (
                    <Link to="/portfolio" className="home-button" key={button.id}>
                        {button.text}
                    </Link>
                );
            case 3:
                return (
                    <Link to="/suggestion" className="home-button" key={button.id}>
                        {button.text}
                    </Link>
                );
            case 4:
            ...
            case 5:
                return (
                    <Link to="/inquiry" className="home-button" key={button.id}>
                        {button.text}
                    </Link>
                );
            default:
    ...
    return (
        <div className="home-container">
            ...
            <div className="home-about-box">
                <img src={require("../images/home/logo.png").default} className="home-about-img" alt="logo" />
