...
const Notice = () => {
    ...
    const data = `<h2 class="ql-indent-1">asdfasdfasdfsdfsadf<span style="color: rgb(178, 107, 0);">asdfsadfsadfasdf</span></h2><ul><li><strong>qweqeqe</strong></li><li><strong>asdasd</strong></li></ul><p><strong>asdasd</strong></p>`;
